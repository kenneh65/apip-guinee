    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
	 ...
	 $this->langue = $options['langue'];
        ...
        $builder
            ...
            ->add('telephone',null, array( 'attr'=>array('required' => false, 'placeholder'=>'placeholder.telephone')))
            ->add('portable',null, array( 'attr'=>array('required' => false, 'placeholder'=>'placeholder.telephone')))
