...
//die(dump($listDocumentForCollected));
        if (isset($idd)) {
            ...
            return $this->render('BanquemondialeBundle:Default:DemandeCreation/layout/retraitDossier.html.twig', array('listDocument' => $listDocumentForCollected, 'listDocumentNotCollected' => $listDocumentNotCollected, 'idd' => $idd, 'statutRetrait' => 1));
        }
    }
    ...
    public function retraitDossierPartielAction($idd = null) {
        ...
        if (isset($idd)) {
            ...
            //$listDocDelivres=$em->getRepository('BanquemondialeBundle:FormulaireDelivre')->getListFormulaireDelivre($idd, $langue);
            return $this->render('BanquemondialeBundle:Default:DemandeCreation/layout/retraitDossier.html.twig', array('listDocument' => $listDocumentForCollected, 'listDocumentNotCollected' => $listDocumentNotCollected, 'idd' => $idd, 'statutRetrait' => 2));
        }
    }
