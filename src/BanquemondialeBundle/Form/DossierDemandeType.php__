...
class DossierDemandeType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder
                ...
                ->add('boitePostale')
                ->add('telephone', null, array('attr' => array('required' => true, 'placeholder' => 'placeholder.telephone')))
                ->add('telephone2', null, array('attr' => array('required' => false, 'placeholder' => 'placeholder.telephone')))
                ->add('email', 'email', array('required' => true))
                ->add('duree', null, array('required' => true))
                ->add('nombreSalariePrevu', null, array('required' => true))
                ->add('dateDebut', 'date', array('widget' => 'single_text', 'format' => 'dd-MM-yyyy', 'attr' => array('placeholder' => 'message.placeholder.date'), 'required' => true))
