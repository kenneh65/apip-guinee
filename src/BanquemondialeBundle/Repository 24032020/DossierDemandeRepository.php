...
class DossierDemandeRepository extends EntityRepository
{
    ...
    {
        $query= $this->getEntityManager()->createQuery("SELECT a FROM BanquemondialeBundle:dossierdemande a 
                        left  JOIN UtilisateursBundle:Utilisateurs u with a.utilisateur=u.id and a.statut is NULL AND a.utilisateur=:idu
...
//            ->andwhere('a.statut is null')->andWhere('a.utilisateur=:idu')
//            ->setParameter('idu', $idUser);
...
//        }
      ...
      // die(var_dump(($query->getQuery()->getResult())));
       // die(dump($query->getQuery()->getEntityManager()));
